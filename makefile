...
bmm-dem: bmm-dem.o \
	dem.o endy.o fp.o geom.o geom2d.o hack.o hist.o io.o ival.o msg.o \
...
bmm-glut: bmm-glut.o \
	dem.o endy.o fp.o geom.o geom2d.o gl2.o glut.o hack.o hist.o io.o ival.o msg.o \
	neigh.o opt.o random.o sec.o sig.o size.o str.o tle.o
...
bmm-sdl: bmm-sdl.o \
	dem.o endy.o fp.o geom.o geom2d.o gl.o hack.o hist.o io.o ival.o msg.o \
...
tests: tests.o \
	endy.o fp.o geom.o geom2d.o hack.o hist.o io.o ival.o msg.o \
	neigh.o opt.o random.o sec.o sig.o size.o str.o tle.o
